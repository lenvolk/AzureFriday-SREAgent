---
name: azure-ai
description: "Azure AI router for AI Search, Speech, OpenAI, and Document Intelligence. Triggers: AI Search, vector search, hybrid search, semantic search, speech-to-text, text-to-speech, transcribe, OCR, embeddings."
argument-hint: "Azure AI task or service"
license: MIT
metadata:
  author: Microsoft
  version: "1.1.1"
