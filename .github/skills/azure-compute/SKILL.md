---
name: azure-compute
description: "Azure VM and VMSS router for recommendations, pricing, autoscale, connectivity troubleshooting, capacity reservations, and Essential Machine Management. Triggers: VM, VMSS, scale set, VM size, pricing, autoscale, load balancer, RDP, SSH, NSG, reset password, CRG, capacity reservation, EMM, machine enrollment."
argument-hint: "VM recommendation, troubleshooting, capacity, or EMM task"
license: MIT
metadata:
  author: Microsoft
  version: "2.4.2"
